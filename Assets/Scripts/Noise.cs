...
public static class Noise
{
    ...
    {
        point *= frequency;
        int v0 = Mathf.FloorToInt(point.x);
        float t = point.x - v0;
        v0 &= hashMask;
        int v1 = v0 + 1;
    ...
    {
        point *= frequency;
        int vX0 = Mathf.FloorToInt(point.x);
        int vY0 = Mathf.FloorToInt(point.y);
        float tx = point.x - vX0;
        float ty = point.y - vY0;
        vX0 &= hashMask;
        vY0 &= hashMask;
        int vX1 = vX0 + 1;
        int vY1 = vY0 + 1;
    ...
    public static float Value3D(Vector3 point, float frequency)
    {
        ...
        int vX0 = Mathf.FloorToInt(point.x);
        int vY0 = Mathf.FloorToInt(point.y);
        int vZ0 = Mathf.FloorToInt(point.z);
        float tx = point.x - vX0;
        float ty = point.y - vY0;
        float tz = point.z - vZ0;
        vX0 &= hashMask;
        vY0 &= hashMask;
        vZ0 &= hashMask;
        int vX1 = vX0 + 1;
        ...
        int h01 = hash[h0 + vY1];
        int h11 = hash[h1 + vY1];
        int h000 = hash[h00 + vZ0];
        int h100 = hash[h10 + vZ0];
        int h010 = hash[h01 + vZ0];
        int h110 = hash[h11 + vZ0];
        int h001 = hash[h00 + vZ1];
        int h101 = hash[h10 + vZ1];
        int h011 = hash[h01 + vZ1];
        int h111 = hash[h11 + vZ1];
